        ...
        <Flex maxW='100%' direction={{ base: 'column', lg: 'row' }} alignItems='center' justifyContent='space-between'>
          ...
          <Box maxW='65%' mt={{ base: '1.25rem', lg: '0' }} mb={{ base: '1.25rem', lg: '0' }} mr={5} ml={5}>
            <Text color='secondary.700'>
              The aim of this website is quite simple: making looking for a cocktail easy and fun. You can look through our listing, search
              by name, ingredients or categories, but you can also take a little test and find out what your new favourite cocktail will be!
